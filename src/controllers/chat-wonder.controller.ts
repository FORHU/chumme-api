              ...
              try {
                ...
                if (wantsVideo) {
                  ...
                  if (mergedVideos.length === 0) {
                    ...
                    logger.info(
                      `[CHAT-WONDER-STREAM] No DB videos found — searching YouTube for: "${ytQuery}"`,
                    );
                    try {
                      ...
                      logger.warn(
                        `[CHAT-WONDER-STREAM] Direct YouTube search failed: ${ytErr?.message}`,
                      );
                    }
                  }
                } else {
