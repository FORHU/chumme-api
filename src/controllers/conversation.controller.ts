...
export default class ConversationCtrl {
    ...
    static async createConversation(
        ...
        try {
            logger.info(
                "[CONVERSATION.CONTROLLER] - Creating new conversation"
            );
    ...
    static async getConversations(
        ...
        try {
            logger.info(
                "[CONVERSATION.CONTROLLER] - Fetching conversations list"
            );
            const conversations = await ConversationSvc.getConversationsList(
                userId,
                {
                    page: value.page,
                    limit: value.limit,
    ...
    static async updateTitle(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            const updatedConversation =
                await ConversationSvc.updateConversationTitle(
                    conversationId,
                    userId,
                    title
                );
