...
export const getAllEmotions = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to fetch emotions",
        });
    }
};
...
export const getUserEmotions = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to fetch user emotions",
        });
    }
};
...
export const addUserEmotions = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to add emotions",
        });
    }
};
...
export const removeUserEmotion = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message: error instanceof Error ? error.message : "Failed to remove emotion",
        });
    }
};
